        ...
        public async Task<ActionResult> LoginUser(Login login)
        {
            ...
            try
            {
                ...
                if (user_ != null)
                {
                    ...
                    var result = await signInManager.PasswordSignInAsync(user_, login.Password,
            ...
            return Ok(new { message = "Login Successful.", user = userSend });
        }
